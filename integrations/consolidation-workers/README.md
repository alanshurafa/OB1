...
Verify the bio profile was created:
...
- **Bio worker**: A single canonical biographical profile thought exists, summarizing the person's roles, projects, values, and key relationships from scattered notes. Running again updates the existing profile rather than creating duplicates.
