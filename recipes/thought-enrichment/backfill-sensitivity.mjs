 ...
 * runs detectSensitivity() on their content, and updates any that
 * should be 'personal' or 'restricted'.
 *
 * Usage:
...
const SUPABASE_URL = envVars.SUPABASE_URL || `https://${envVars.SUPABASE_PROJECT_REF}.supabase.co`;
